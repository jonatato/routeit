      ...
      <main className="mx-auto flex w-full max-w-6xl flex-col gap-14 px-6 pb-24 pt-6">
        <section className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div className="space-y-6">
            <p className="inline-flex w-fit items-center rounded-full border border-warning/40 bg-card/80 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-warning">
          ...
          <div className="relative rounded-[32px] border border-border bg-card/90 p-6 shadow-lg">
            <div className="absolute -right-6 -top-6 hidden h-24 w-24 rounded-full bg-warning/30 blur-2xl md:block" />
            <div className="space-y-4">
              <div className="rounded-2xl border border-warning/30 bg-warning/15 p-4">
                <div className="flex items-center gap-3 text-sm font-semibold text-warning">
                  <CalendarDays className="h-4 w-4" />
                  Hoy en Tokio
                </div>
                <p className="mt-2 text-xs text-warning">09:00 Mercado de Tsukiji | 13:00 TeamLab</p>
              </div>
              ...
              <div className="rounded-2xl border border-border bg-muted/30 p-4">
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-mutedForeground">Checklist</p>
                <div className="mt-3 grid gap-2 text-xs text-mutedForeground">
                  <span className="flex items-center gap-2"><CheckCircle2 className="h-3 w-3 text-success" /> Pasaporte</span>
                  <span className="flex items-center gap-2"><CheckCircle2 className="h-3 w-3 text-success" /> Seguro de viaje</span>
                  <span className="flex items-center gap-2"><CheckCircle2 className="h-3 w-3 text-success" /> Check-in vuelo</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="features" className="grid gap-6 md:grid-cols-2">
          {[
            ...
            <div key={item.title} className="rounded-3xl border border-border bg-card/80 p-6 shadow-sm">
              <div className="flex items-center gap-3 text-sm font-semibold text-foreground">
                <span className="rounded-2xl bg-warning/20 p-2 text-warning">
        ...
        <section id="how" className="grid gap-6 rounded-[28px] border border-border bg-gradient-to-br from-card via-card to-muted/20 p-8 md:grid-cols-3">
          {[
            ...
            <div key={item.step} className="space-y-2">
              <p className="text-xs font-semibold uppercase tracking-[0.3em] text-warning">{item.step}</p>
          ...
          <div className="rounded-3xl border border-border bg-card/90 p-6 shadow-sm">
            ...
            <div className="mt-4 space-y-3">
              {['09:30 Palacio Real', '13:00 Street food tour', '18:00 Check-in hotel'].map(item => (
                <div key={item} className="rounded-2xl border border-border bg-muted/30 px-4 py-3 text-sm">
                  {item}
                </div>
              ))}
            </div>
          ...
          <div className="rounded-3xl border border-border bg-card/90 p-6 shadow-sm">
            ...
            <div className="mt-4 space-y-3">
              {['Tu viaje empieza en 7 dias', 'Checklist: pasaporte, seguro', 'Actualizacion en gastos'].map(item => (
                <div key={item} className="rounded-2xl border border-warning/30 bg-warning/15 px-4 py-3 text-sm text-warning">
                  {item}
                </div>
              ))}
            </div>
        ...
        <section className="grid gap-6 rounded-3xl border border-border bg-card/80 p-8 md:grid-cols-2">
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm text-mutedForeground">
              <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-success" /> Documentos y visados</li>
              <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-success" /> Equipaje por clima</li>
              <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-success" /> Reservas y tickets</li>
            </ul>
          </div>
          <div className="rounded-2xl border border-border bg-muted/30 p-5">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-mutedForeground">Checklist personal</p>
            <div className="mt-4 space-y-2 text-sm text-mutedForeground">
              <div className="rounded-xl border border-border bg-card px-3 py-2">Power bank</div>
              <div className="rounded-xl border border-border bg-card px-3 py-2">Adaptador universal</div>
              <div className="rounded-xl border border-border bg-card px-3 py-2">Medicamentos</div>
            </div>
          </div>
        </section>

        <section className="flex flex-col items-center gap-4 rounded-3xl border border-border bg-gradient-to-br from-warning/20 via-card to-card p-10 text-center">
